            ...
            <div class="col-md-10 col-md-offset-1 panel panel-default">
                <div class="panel-body text-center">
                    <form class="form-signin" method="POST" action="{{ route('login') }}">
                        ...
                        <img style="margin-top: 35px;" src="lock.svg" alt="" width="72" height="72">
                        
                        <h1 class="h2" style="margin-top: 10px;">Entrar</h1>
                        
                        @if ($errors->any())
                            <div class="alert alert-danger alert-dismissible" style="padding: 5px;" role="alert">
                        ...
                        <input id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" placeholder="Introduce tu Nº de DNI" required autofocus>
                        ...
                        <p></p>
                        <p class="text-muted" style="margin: inherit">&copy; 2017- {{date('yy')}} </p>
                    </form>
