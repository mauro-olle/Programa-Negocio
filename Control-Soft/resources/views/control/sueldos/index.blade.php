                ...
                @foreach ($encargados as $encargado)
                    <tr>
                        ...
                        <td>
                            <form class="form-inline" name="myForm" method="POST" action="{{ url('admin/control/') }}">
                                ...
                                <input type="hidden" name="detalle" value="Pago de sueldo a {{ $encargado->nombre }}">
                    ...
                    <tr class="collapse" id="collapseExample{{ $encargado->id }}">
                        <td class="col-xs-10" colspan="7" >
                            <form class="form-inline" method="POST" action="{{ url('/admin/control/sueldos/'. $encargado->nombre) }}">
                                {!!csrf_field()!!}
                                <div class="form-group">
                                    <label>Historial de sueldos para {{ $encargado->nombre }} desde</label>
